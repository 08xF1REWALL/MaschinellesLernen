...
for c in np.arange(-5, 5):
    ...
    lr.fit(X_train_std, y_train)
    # coef_[1] Repräsentiert die gelernten Gewichte (Koeffizienten) der Merkmale für das angepasste LogisticRegression-Modell.
    # Jedes Element entspricht dem Beitrag eines Merkmals zur Vorhersage.
...
plt.legend(loc='upper left')
#plt.tight_layout()
#plt.savefig('images/03_13.png', dpi=300)
plt.show()